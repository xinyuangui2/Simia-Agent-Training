...
class RayAgentTrainer(VerlRayPPOTrainer):
    ...
    def _maybe_log_generations(self, inputs, outputs, scores, _type="val"):
        ...
        self.logger.log_generations(samples=samples, step=self.global_steps)
    ...
    def fit(self):
        ...
        if self.val_reward_fn is not None and self.config.trainer.get("val_before_train", True):
            ...
            self.logger.log_metrics(data=val_metrics, step=self.global_steps)
        ...
        for step in range(self.total_training_steps):
            ...
            self.logger.log_metrics(data=metrics, step=self.global_steps)
